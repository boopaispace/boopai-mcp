...
# Import the tools
from boopai_mcp.tools import token_launcher_tool, token_buyer_tool, birdeye_trending_tokens_tool, birdeye_top_traders_tool

# Store notes as a simple key-value dict to demonstrate state management
notes: dict[str, str] = {}

server = Server("boopai-mcp")
