...
from boopai_mcp.utils import prepare_ipfs
...
async def run_test(image_url: str = "https://sapphire-working-koi-276.mypinata.cloud/ipfs/bafkreiayu3rjnfvtmaj3dp67g2pny3kx42vzoxdkgdokbcvhdqe3rel7ym",
                   ...
                   twitter: str = "https://twitter.com/boopaitoken",
                   telegram: str = "https://t.me/boopaitoken",
                   website: str = "https://boopai.fun"):
    """
    Run the IPFS test
...
def parse_args():
    ...
    parser.add_argument('--twitter', type=str,
                        default="https://twitter.com/boopaitoken", help='Twitter URL (optional)')
    parser.add_argument('--telegram', type=str,
                        default="https://t.me/boopaitoken", help='Telegram URL (optional)')
    parser.add_argument('--website', type=str,
                        default="https://boopai.fun", help='Website URL (optional)')
