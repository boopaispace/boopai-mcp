...
from boopai_mcp.settings import (
    client,
    UNIT_PRICE,
    UNIT_BUDGET,
    TOKEN_PROGRAM,
...
async def get_close_wsol_instruction(
    ...
    from boopai_mcp.settings import TOKEN_PROGRAM
